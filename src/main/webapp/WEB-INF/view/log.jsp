...
<body class="gray-bg">
	<div class="panel-body">
		...
		<div class="row">
				...
				<div class="col-lg-3">
					<div class="input-group">
						<span class="input-group-addon">操作人</span> <input type="text"
							name="username" class="form-control" id="txt_search_username">
					</div>
				</div>
				<div class="col-lg-3">
					<div class="input-group">
						<span class="input-group-addon">操作类型</span> <input type="text"
							name="operation" class="form-control" id="txt_search_operation">
					</div>
				</div>
				<div class="col-lg-3">
					<div class="input-group">
			...
			<!--删除对话框 -->
			<div class="modal fade" id="modal_log_del" role="dialog"
				aria-labelledby="modal_log_del" aria-hidden="true">
			...
			<div class="ui-jqdialog modal-content" id="alertmod_table_log_mod"
				dir="ltr" role="dialog" aria-labelledby="alerthd_table_log"
				aria-hidden="true"
				...
				<div class="ui-jqdialog-titlebar modal-header"
					id="alerthd_table_log" style="cursor: move;">
					<span class="ui-jqdialog-title" style="float: left;">注意</span> <a
						id="alertmod_table_log_mod_a" class="ui-jqdialog-titlebar-close"
			...
			<script type="text/javascript">
				...
				$("#del_log_btn").click(
						function() {
							var getSelections = $('#table_log').bootstrapTable(
									'getSelections');
							var idArr = new Array();
							var ids;
																...
																.post(
																		...
																		function(
																			...
																			if (res.success) {
																				...
																				layer
																						.alert(
																								"<a href='javascript:downloadLogBus()'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备份成功点击查看备份</a>",
																								{
																									icon : 1
																								});
																			} else {
